...
public final class ViewCategoriesSoldImpl implements Initializable, ViewCategoriesSold {
    ...
    public ViewCategoriesSoldImpl(final ControllerAnalytic controller) {
