...
public final class ViewStockSetFiltersImpl implements Initializable, ViewStockSetFilters {
    ...
    public ViewStockSetFiltersImpl(final ViewStock viewStock, final ControllerStock controller) {
